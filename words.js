const TOP_500_WORDS = [
  ...
  "problem", "complete", "room", "knew", "since", "ever", "piece", "told", "usually", "friends",
  ...
  "notice", "south", "sing", "war", "ground", "fall", "king", "town", "unit", "figure",
  "certain", "field", "travel", "wood", "fire", "upon", "done", "english", "road", "half",
  "ten", "fly", "gave", "box", "finally", "wait", "correct", "oh", "quick", "person",
  ...
  "government", "filled", "heat", "full", "hot", "check", "object", "rule", "among", "noun",
  "power", "cannot", "able", "six", "size", "dark", "ball", "material", "special", "heavy",
  "fine", "pair", "circle", "include", "built", "care", "tail", "students", "winter", "written"
];
